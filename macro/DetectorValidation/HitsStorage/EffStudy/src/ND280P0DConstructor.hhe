#ifndef ND280P0DConstructor_hh_seen
#define ND280P0DConstructor_hh_seen
// $Id: ND280P0DConstructor.hh,v 1.6 2011/06/07 18:37:40 mcgrew Exp $
//
...
class ND280P0DConstructor : public ND280Constructor {
public:
  //ND280P0DConstructor(G4String n, ND280UserDetectorConstruction* c)
    ND280P0DConstructor(G4String n, ExN02DetectorConstruction* c)
        : ND280Constructor(n,c) {Init();};
    ND280P0DConstructor(G4String n, ND280Constructor* p)
        : ND280Constructor(n,p) {Init();};
    virtual ~ND280P0DConstructor();
