#ifndef ND280P0DECalRightConstructor_hh_seen
#define ND280P0DECalRightConstructor_hh_seen
...
class ND280P0DECalRightConstructor : public ND280ECalModuleConstructor
{
	public:
		
		ND280P0DECalRightConstructor(G4String name, ND280Constructor* parent)
			: ND280ECalModuleConstructor(name, parent)
			{	this->Init();	}
		
		virtual ~ND280P0DECalRightConstructor(){}
