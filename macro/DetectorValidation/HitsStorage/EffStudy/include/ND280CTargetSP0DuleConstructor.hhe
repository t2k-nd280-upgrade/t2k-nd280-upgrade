#ifndef ND280CTargetSP0DuleConstructor_hh_seen
#define ND280CTargetSP0DuleConstructor_hh_seen
// $Id: ND280CTargetSP0DuleConstructor.hh,v 1.6 2011/09/08 21:36:13 mcgrew Exp $
//

#include "ND280Constructor.hh"

/// Create the Central Water Target SuperP0Dule.  This volume includes the
/// electronics mounted on the side of the superP0Dule.
class ND280CTargetSP0DuleConstructor: public ND280Constructor {
public:
    ND280CTargetSP0DuleConstructor(G4String n, 
				   //ND280UserDetectorConstruction* c)
                                    ExN02DetectorConstruction* c)
        : ND280Constructor(n,c) {Init();};
    ND280CTargetSP0DuleConstructor(G4String n, ND280Constructor* p)
        : ND280Constructor(n,p) {Init();};
    virtual ~ND280CTargetSP0DuleConstructor();
    ...
    /// and the electronics ladder.  This is the space required to install the
    /// MPPCs
