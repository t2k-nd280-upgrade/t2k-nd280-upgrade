#ifndef ND280ModuleConstructor_hh_seen
#define ND280ModuleConstructor_hh_seen
...
/// Construct a module for the ND280mc from components.

class ND280ModuleConstructor : public ND280Constructor {

public:

  //ND280ModuleConstructor(G4String n, ND280UserDetectorConstruction* c)
  ND280ModuleConstructor(G4String n, ExN02DetectorConstruction* c)
    : ND280Constructor(n,c) {Init();};

    ND280ModuleConstructor(G4String n, ND280Constructor* p)
        : ND280Constructor(n,p) {
        Init();};

    virtual ~ND280ModuleConstructor();
...
private:
    ...
    /// A vector of ComponentConstructors that will be added to the module.
    typedef std::vector<ND280ComponentConstructor*> PartsList;
...
class ND280ModuleConstructorMessenger: public ND280ConstructorMessenger {
private:
    ND280ModuleConstructor* fConstructor;
...
public:
    ND280ModuleConstructorMessenger(ND280ModuleConstructor* c,
    ...
    virtual ~ND280ModuleConstructorMessenger() {
        delete fClearCMD;
        delete fAddCMD;
        delete fRepeatCMD;
        delete fWidthCMD;
    ...
    void SetNewValue(G4UIcommand *cmd, G4String val) {
        if (cmd==fClearCMD) {
            fConstructor->ClearComponentList();
        }
        else if (cmd==fAddCMD) {
            fConstructor->AddComponent(val);
        }
            ...
            fConstructor->SetRepetitions(repetitions,count);
        }
