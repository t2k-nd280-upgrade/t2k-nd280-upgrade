...
#ifndef ExN02PhysicsListMessenger_h
#define ExN02PhysicsListMessenger_h 1
...
class ExN02PhysicsListMessenger: public G4UImessenger
{
public:
  ExN02PhysicsListMessenger(ExN02PhysicsList*);
  ~ExN02PhysicsListMessenger();
    
    void SetNewValue(G4UIcommand*, G4String);
    
  private:
    ExN02PhysicsList*          ExN02List;
  ...
  G4UIcmdWithABool   *UsePAIModelCmd;
  G4UIcmdWithAString *SetHadronicPhysListCmd;
};
