...
#define THRESHOLD 1.5 // p.e. //forB2 2014/1/28
...
//Get Hit Collection of This Event
  ...
  if(hlhitcol){
    ...
    for(int l=0; l<nhitshlayer; l++){
      ...
      double posxy=100, posz=100;///////////////////////////B2 add =0
      //double posxy, posz;///////////////////////////
  ...
  if( vlhitcol ){
    ...
    for(int l=0; l<nhitsvlayer; l++){
      ...
      INGRID_Dimension *fdim = new INGRID_Dimension();
      double posxy=100, posz=100;///////////////////add =0 B2
      //double posxy, posz;///////////////////////////
      fdim -> get_posXY( mod, view, pln, ch,
			 &posxy, &posz	 );
      //
  ...
  // Fill Tree added by koga for BG study 2014/2/7
/*
