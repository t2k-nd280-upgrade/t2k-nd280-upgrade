...
G4VPhysicalVolume* IngridDetectorConstruction::Construct()
{
  ...
  else if(mode==PROTON) { start_mod=16; stop_mod=17; }
...
//////////////////////////////////////////////////////////////
  ...
  G4ExtrudedSolid* vscint2_int = new G4ExtrudedSolid("vscint2_int", svdim, zsec);
  ...
  G4ExtrudedSolid* hscint2_int = new G4ExtrudedSolid("hscint2_int", shdim, zsec);
  G4LogicalVolume* hscint2_intLV = new G4LogicalVolume(hscint2_int,Scinti,"hscint2_intLV");
  G4VisAttributes* hscint2_intVisAtt = new G4VisAttributes(G4Color(1.,0.,0.));
  ...
  //SciBar horizontal scintillator
  G4Box* vlayer2 = new G4Box("xview2",scibar2_y,scibar_x,scibar2_z);
  ...
  */
  ...
  for(int i=0;i<18;i++){
	...
	new G4PVPlacement(0,G4ThreeVector(-0.5*cm,65.5*cm,z),PLvetoLV,vetoname[3],moduleLV[k],false, 88*k+i+17*3);  // UP
	new G4PVPlacement(0,G4ThreeVector(1.5*cm,-65.5*cm,z),PSvetoLV,vetoname[2],moduleLV[k],false, 88*k+i+17*2); // DOWN
	new G4PVPlacement(TB2LR,G4ThreeVector(65.5*cm,-2.5*cm,z),PLvetoLV,vetoname[1],moduleLV[k],false, 88*k+i+17); // LEFT
	new G4PVPlacement(TB2LR,G4ThreeVector(-65.5*cm,0.5*cm,z),PLvetoLV,vetoname[0],moduleLV[k],false, 88*k+i); // RIGTH
	      }
  }
  }
  ...
  vscint2_intLV->SetSensitiveDetector( ahlayerSD );//SciBar type added by kikawa
