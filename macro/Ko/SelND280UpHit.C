 ...
 )
{
  ...
  hPEVsTime_tot = new TH2F("hPEVsTime_tot","hPEVsTime_tot",300,0,300,40,0,20);
  hPE_tot = new TH1F("hPE_tot","hPE_tot",300,0,300);
  ...
  */
  ...
  for(int ievt=evtfirst;ievt<=EntryLast;ievt++){ // get last entry
    ...
    hPEVsTime_x[ievt] = new TH2F(name,name,300,0,300,40,0,20);
    name = TString::Format("hPEVsTime_y_%d",ievt);
    hPEVsTime_y[ievt] = new TH2F(name,name,300,0,300,40,0,20);
    name = TString::Format("hPEVsTime_z_%d",ievt);
    hPEVsTime_z[ievt] = new TH2F(name,name,300,0,300,40,0,20);    

    name = TString::Format("hPE_x_%d",ievt);
    hPE_x[ievt] = new TH1F(name,name,300,0,300);
    name = TString::Format("hPE_y_%d",ievt);
    hPE_y[ievt] = new TH1F(name,name,300,0,300);
    name = TString::Format("hPE_z_%d",ievt);
    hPE_z[ievt] = new TH1F(name,name,300,0,300);
    ...
    for(int ihit=0;ihit<NHits;ihit++){ // get last entry
      ...
      if (pex<2.5 && pez==0.0 ) continue;
      if (pez<2.5 && pex==0.0 ) continue;
