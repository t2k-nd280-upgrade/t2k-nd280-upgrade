...
const double CTargetX = 230.0;//cm size of WAGASCI water module HK
const double CTargetY = 230.0;//cm HK
const double CTargetZ = 55.0;//cm HK

//air box of all of WAGASCHI
const double CWagaX = 2.60;//m HK
const double CWagaY = 2.60;//m HK
...
//target and veto
const double CWagaboxX = 1.25;//m //HK
const double CWagaboxY = 1.25;//m //HK
const double CWagaboxZ = 1.0;//m //HK
//downstream MRD
...
const double CWagaboxsideZ = 1.51;//m //WIDTH
//upstream VETO
...
const double CWagaboxposZ = -1.0;//m //HK: middle of WAGASCI box
//downstream MRD
...
//horizontal layers
//for side MRD 
const double CHlayer2X = 1.5;//m //WIDTH
...
const double CHlayer6X = 1.15;//m //HK
...
const double CVlayer6Y = 1.15;//m //HK
...
const double HbarLenX = waterLenX-subHBarX; //we must take "HbarLenY<subHBarX" //2014/6/11 //HK!!!!!!!!!!!!!!!!BUG HERE: I replaced ctargetx by waterLenX (because we want in mm)
...
const int latice_sciNum   = (int)( (HbarLenX+subHBarX)/(sciSpace*2) - 1);//HK
const int latice_sciNumX   = (int)( (HbarLenX+subHBarX)/(sciSpace*2) - 1);//HK
const int latice_sciNumY   = (int)( (HbarLenY+subHBarY)/(sciSpace*2) - 1);//HK
//const int latice_sciNum   = 41;//(int)( (HbarLenX+subHBarX)/(sciSpace*2) - 1);//HK
const int plan2D_sciNum = (int)( (HbarLenX+subHBarX)/(sciSpace) - 1);//HK
const int plan2D_sciNumX = (int)( (HbarLenX+subHBarX)/(sciSpace) - 1);//HK
const int plan2D_sciNumY = (int)( (HbarLenY+subHBarY)/(sciSpace) - 1);//HK
//const int plan2D_sciNum = 91;
//const int latice_plnNum     = 61;   //2014/6/11
const int latice_plnNum     = 8;   //Number of scintillator in one of the lattice HK
...
const double CStartmod2_sci_v = -150; //cm WIDTH!!!!
