...
////////B2////////////////////
  if(mod==1){	
      *posxy   = (B2ScintiWidthfor)*ch;
      if(view == 1) {*posz    = ( B2PlnThickfor + B2IronThickfor ) * pln ;}
      else if(view == 0){*posz    = ( B2PlnThickfor + B2IronThickfor ) * pln + B2ScintiThickfor;}
      return true; 
  }
  if(mod==2){
      *posxy   = (B2ScintiWidthside)*ch;
      if(view == 1) {*posz    = ( B2PlnThickside + B2IronThickside ) * pln ;}
      else if(view == 0){*posz    = ( B2PlnThickside + B2IronThickside ) * pln + B2ScintiThickside;}
      return true;
  }
  if(mod==3){
      *posxy   = (B2ScintiWidthback)*ch;
      if(view == 1) {*posz    = ( B2PlnThickback ) * pln ;}
      else if(view == 0){*posz    = ( B2PlnThickback ) * pln - B2ScintiThickback;}
      return true;
  }
  if(mod==4){
	*posz = 0;
  ...
  if(mod==5){
      *posxy   = (B2ScintiWidthinwater)*ch;
      if(view == 1) {*posz    = ( B2PlnThickinwater ) * pln ;}
      else if(view == 0){*posz    = ( B2PlnThickinwater ) * pln + B2ScintiThickinwater;}
      return true;
  }
