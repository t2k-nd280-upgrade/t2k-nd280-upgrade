#ifndef ND280WaffleActiveConstructor_hh_seen
#define ND280WaffleActiveConstructor_hh_seen
// $Id: ND280WaffleActiveConstructor.hh,v 1.6 2011/06/07 18:37:40 mcgrew Exp $
//
...
//class ND280WaffleActiveConstructor : public ND280Constructor {
class ND280WaffleActiveConstructor {
public:
  //ND280WaffleActiveConstructor(G4String n, ND280UserDetectorConstruction* c)
  /*  ND280WaffleActiveConstructor(G4String n, ExN02DetectorConstruction* c)
      : ND280Constructor(n,c) {Init();};
  ND280WaffleActiveConstructor(G4String n, ND280Constructor* p)
  : ND280Constructor(n,p) {Init();};*/
  //ND280WaffleActiveConstructor() {Init();};

  //virtual ~ND280WaffleActiveConstructor();
