...
const G4double ElecNoise = 0.16;  //  sigma of electronics noise
...
void IngridResponse::ApplyLightCorrection(G4double* edep, G4int mod, G4int view, G4ThreeVector pos){
...
*/
  ...
  *pe = npe;
  ...
  // Electronics noise effect
  npe = gRandom->Gaus(npe,ElecNoise);
  *pe = npe;
