...
class ND280UA1MRDArmMessenger: public ND280ConstructorMessenger {
private:
    ND280UA1MRDArmConstructor* fConstructor;
...
public:
    ND280UA1MRDArmMessenger(ND280UA1MRDArmConstructor* c) 
    ...
    virtual ~ND280UA1MRDArmMessenger() {
        delete fWidthCMD;
        delete fHeightCMD;
        delete fLengthCMD;
...
void ND280UA1MRDArmConstructor::Init(void) {
  ...
  fWidth = (4.0 * (170.5 + 0.5))*mm; // plateCount * plateOffset
    ...
    fSlotLayer = 0;
    fSlotIndex = 0;
    SetMessenger(new ND280UA1MRDArmMessenger(this));
}

G4LogicalVolume *ND280UA1MRDArmConstructor::GetPiece(void) {
