...
TGeoShape* ND280RootGeometryManager::CreateShape(const G4VSolid* theSolid, 
	...
	const int nVSup =  100;//(const int) extr->GetNofVertices();
        G4int nV = extr->GetNofVertices();
	
	//number of z planes
	//const int inZ = ((const int) extr->GetNofZSections());
	//number of vertices in the polygon
	//const int inV = ((const int) extr->GetNofVertices());
	
        //define and pointers
        double vertices_x[nVSup];
        double vertices_y[nVSup];
