...
*/
  ...
  G4VSolid* SlitHorizontalGrid = new G4Box("SlitHorizontalGrid",SlitWidth,SlitThickness,SlitHeight);
  ...
  G4VSolid* SlitVerticalGrid = new G4Box("SlitVerticalGrid",SlitThickness,SlitWidth,SlitHeight);
  ...
  for(int i=0;i<NumberOfSlitsVertical;i++){
   ...
   G4LogicalVolume * ScintiVerticalGridLV = new G4LogicalVolume(ScintiVerticalGridBox,Scintillator,"ScintiGridLV");
