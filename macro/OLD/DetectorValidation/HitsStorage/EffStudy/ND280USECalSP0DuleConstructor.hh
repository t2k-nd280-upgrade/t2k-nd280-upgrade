#ifndef ND280USECalSP0DuleConstructor_hh_seen
#define ND280USECalSP0DuleConstructor_hh_seen
// $Id: ND280USECalSP0DuleConstructor.hh,v 1.5 2011/06/07 15:01:51 mcgrew Exp $
//

#include "ND280Constructor.hh"

/// Create the Upstream ECal SuperP0Dule.  This volume includes the
/// electronics mounted on the side of the superP0Dule.
class ND280USECalSP0DuleConstructor: public ND280Constructor {
public:
  //ND280USECalSP0DuleConstructor(G4String n, ND280UserDetectorConstruction* c)
    ND280USECalSP0DuleConstructor(G4String n, ExN02DetectorConstruction* c)
        : ND280Constructor(n,c) {Init();};
    ND280USECalSP0DuleConstructor(G4String n, ND280Constructor* p)
        : ND280Constructor(n,p) {Init();};
    virtual ~ND280USECalSP0DuleConstructor();
