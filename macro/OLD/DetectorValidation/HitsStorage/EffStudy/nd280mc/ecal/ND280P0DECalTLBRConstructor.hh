#ifndef ND280P0DECalTLBRConstructor_hh_seen
#define ND280P0DECalTLBRConstructor_hh_seen
...
class ND280P0DECalTLBRConstructor : public ND280ECalModuleConstructor
{
	public:
		
		ND280P0DECalTLBRConstructor(G4String name, ND280Constructor* parent)
			: ND280ECalModuleConstructor(name, parent)
			{	this->Init();	}
		
		virtual ~ND280P0DECalTLBRConstructor(){}
