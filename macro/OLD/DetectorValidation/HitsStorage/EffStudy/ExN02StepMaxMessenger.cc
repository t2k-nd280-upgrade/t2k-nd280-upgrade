...
ExN02StepMaxMessenger::ExN02StepMaxMessenger(ExN02StepMax* stepM)
...
ExN02StepMaxMessenger::~ExN02StepMaxMessenger()
{
  delete fStepMaxCmd;
}
...
void ExN02StepMaxMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
