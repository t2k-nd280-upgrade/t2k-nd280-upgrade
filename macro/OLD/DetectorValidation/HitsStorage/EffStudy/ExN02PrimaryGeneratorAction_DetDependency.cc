...
:myDetector(myDC)
{
  ...
  G4String particlename = "pi-"; //"proton"; // pi-
  G4double particleenergy = 0.2; // GeV

  G4cout << G4endl
	 << "Particle gun:" << particlename << G4endl
	 << "Particle energy: " << particleenergy << G4endl
	 << G4endl;
  ...
  //particleGun->SetParticleMomentumDirection(G4ThreeVector(0.,1.,0.)); // Along Y
  particleGun->SetParticleMomentumDirection(G4ThreeVector(0.,0.,1.)); // Along Z
...
{ 
  ...
  //particleGun->SetParticlePosition(G4ThreeVector(0.*cm,position,0.*cm));
