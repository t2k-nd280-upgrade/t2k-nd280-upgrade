...
class ExN02ActionInitialization : public G4VUserActionInitialization
{
public:
  ExN02ActionInitialization(ExN02DetectorConstruction*);
  virtual ~ExN02ActionInitialization();
