...
#ifndef INCLUDE_EXN02GEOTREE_H 
#define INCLUDE_EXN02GEOTREE_H 1
...
public: 
  ...
  ExN02GeoTree( ); 
  ExN02GeoTree(G4VPhysicalVolume* vol, const G4ElementTable* et, 
               const G4MaterialTable* mt);
  
  virtual ~ExN02GeoTree( );
