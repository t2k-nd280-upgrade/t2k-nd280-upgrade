#ifndef ND280P0DSideLadderConstructor_hh_Seen
#define ND280P0DSideLadderConstructor_hh_Seen
// $Id: ND280P0DSideLadderConstructor.hh,v 1.1 2009/11/21 14:39:22 mcgrew Exp $
//
...
class ND280P0DSideLadderConstructor : public ND280Constructor {
public:
    ND280P0DSideLadderConstructor(G4String n,
				  //ND280UserDetectorConstruction* c)
				  ExN02DetectorConstruction* c)
        : ND280Constructor(n,c) {Init();};
    ND280P0DSideLadderConstructor(G4String n, ND280Constructor* p)
        : ND280Constructor(n,p) {Init();};
    virtual ~ND280P0DSideLadderConstructor(); 
