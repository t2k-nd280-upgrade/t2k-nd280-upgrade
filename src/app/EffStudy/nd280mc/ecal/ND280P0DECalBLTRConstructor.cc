...
void ND280P0DECalBLTRConstructor::Init() {
  SetLengthX(2454.0*CLHEP::mm);
  SetWidthY(1584.0*CLHEP::mm);
  fModuleHeightZ = 147.0*CLHEP::mm;
    ...
    Get<ND280P0DECalActiveConstructor>("Active").SetIsSide(false);
}

G4LogicalVolume* ND280P0DECalBLTRConstructor::GetPiece() {
    ...
    G4LogicalVolume* bulk_para = components.Bulkhead(bulk_para_x,
                                                     bulk_para_y, 
                                                     bulk_para_z);
