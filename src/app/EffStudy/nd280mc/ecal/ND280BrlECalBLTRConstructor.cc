...
G4LogicalVolume* ND280BrlECalBLTRConstructor::GetPiece() {
    ...
    // Centred in x
    // Offset BlukheadPlateThickness from -ve y face
    ...
    G4LogicalVolume* lid_logical = components.Bulkhead(GetLengthX(), lid_y, lid_z);
    ...
    // Primary Bulkheads
    const double bulk_z = GetHeightZ() - ND280ECal::Brl::LidThicknessTB 
