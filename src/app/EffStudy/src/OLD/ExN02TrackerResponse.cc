...
//
ExN02TrackerResponse::~ExN02TrackerResponse()
{
}

//
void ExN02TrackerResponse::ApplyScintiResponse(G4double* edep, G4Track* aTrack)
{
  //quenching
...
void ExN02TrackerResponse::ApplyScintiResponse2(G4double* edep, G4double* length,G4Track* aTrack)
{
  //quenching                                                                                                                             
...
//
void ExN02TrackerResponse::BirksSaturation(G4double* edep, G4Track* aTrack)
{
...
void ExN02TrackerResponse::BirksSaturation2(G4double* edep, G4double* length, G4Track* aTrack)
{
  //const G4double CBIRKS = sbcard->Birks;
...
//void ExN02TrackerResponse::ApplyLightCollection(G4double* edep, G4int mod, G4int view, G4ThreeVector pos){
void ExN02TrackerResponse::ApplyLightCollection(G4double* edep, G4int mod, G4int view, G4int pln, G4int ch, G4ThreeVector pos){
...
void ExN02TrackerResponse::ApplyFiberResponse(G4double* edep, G4double* time, G4int view, G4ThreeVector pos, G4int mod)
{
  G4double x = 0.;
...
//
void ExN02TrackerResponse::ApplyFiberResponseV(G4double* edep, G4double* time, G4int pln, G4ThreeVector pos)
{
  G4double x = 0.;
...
//
void ExN02TrackerResponse::ApplyMPPCResponse(G4double edep, G4double* pe, G4int mod=0)
{
  G4double npe;
...
//
void ExN02TrackerResponse::ApplyADCResponse(G4double *pe, G4double *lope, G4int* adc, G4int* loadc)
{
...
//
void ExN02TrackerResponse::ApplyTDCResponse(G4double time, G4int* tdc)
{
  *tdc = 0;
}
