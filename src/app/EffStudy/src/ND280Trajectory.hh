#ifndef ND280Trajectory_hh_seen
#define ND280Trajectory_hh_seen
...
class ND280Trajectory : public G4VTrajectory {
public:
  ND280Trajectory();
  
  ND280Trajectory(const G4Track* aTrack);
  ND280Trajectory(ND280Trajectory &);
  virtual ~ND280Trajectory();
  
  inline void* operator new(size_t);
  inline void  operator delete(void*);
  inline int operator == (const ND280Trajectory& right) const {
    return (this==&right);
  } 
  ...
  /// Get the initial CosTheta of the particle at the first trajectory point.
  G4double GetInitialCosTheta() const {return fInitialCosTheta;}
...
extern G4DLLEXPORT G4Allocator<ND280Trajectory> aND280TrajAllocator;
#else
extern G4DLLIMPORT G4Allocator<ND280Trajectory> aND280TrajAllocator;
#endif

inline void* ND280Trajectory::operator new(size_t) {
  void* aTrajectory = (void*) aND280TrajAllocator.MallocSingle();
  return aTrajectory;
}

inline void ND280Trajectory::operator delete(void* aTrajectory) {
  aND280TrajAllocator.FreeSingle((ND280Trajectory*)aTrajectory);
}
#endif
