...
ExN02FieldMessenger::ExN02FieldMessenger(ExN02FieldSetup* fieldSetup)
 : G4UImessenger(),
   ...
   fUpdateCmd(0)
{
  ...
  fFieldDir->SetGuidance("ExN02 field tracking control.");
...
ExN02FieldMessenger::~ExN02FieldMessenger()
{
  delete fStepperCmd;
  delete fMagFieldCmd;
  delete fMinStepCmd;
...
void ExN02FieldMessenger::SetNewValue( G4UIcommand* command, G4String newValue)
{
