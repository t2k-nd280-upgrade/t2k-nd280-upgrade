#ifndef MyND280BeamConstructor_hh_seen
#define MyND280BeamConstructor_hh_seen
//
...
//
// Modified version of ND280BeamConstructor of nd280mc. 
// Cleaned a bit: it was a virtual class inherited from ND280Constructor.
...
class MyND280BeamConstructor {

public:

  MyND280BeamConstructor(G4String n)
    : fMaterialName("Aluminum") {SetName(n); Init();};
  
  ~MyND280BeamConstructor();
