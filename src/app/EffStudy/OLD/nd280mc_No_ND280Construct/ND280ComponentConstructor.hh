...
class ND280ComponentConstructor {
public:
    // ND280ComponentConstructor(G4String n, ND280UserDetectorConstruction* c)
    ...
    ND280ComponentConstructor(G4String n, ExN02DetectorConstruction* c)
        : fLength(0.0), 
          fMaximumWidth(0.0), fMaximumHeight(0.0),
          fMaximumHitLength(5*mm), fMaximumHitSagitta(1*mm) {}
    ND280ComponentConstructor(G4String n)
        : fLength(0.0),
          fMaximumWidth(0.0), fMaximumHeight(0.0),
          fMaximumHitLength(5*mm), fMaximumHitSagitta(1*mm) {}
...
// class ND280ComponentConstructorMessenger: public G4UImessenger {
// private:
...
//       // 
//       // CommandName() is a method of ND280Construct, not available here
//       //
//       //fWidthCMD = new G4UIcmdWithADoubleAndUnit(CommandName("width"),this);
//         fWidthCMD = new G4UIcmdWithADoubleAndUnit(path+"/width",this);
...
//         fHeightCMD = new G4UIcmdWithADoubleAndUnit(path+"/height",this);
...
//         //fMaxWidthCMD = new G4UIcmdWithADoubleAndUnit(CommandName("maxWidth"),this);
//         fMaxWidthCMD = new G4UIcmdWithADoubleAndUnit(path+"/maxWidth",this);
...
//         //fMaxHeightCMD = new G4UIcmdWithADoubleAndUnit(CommandName("maxHeight"),this);
//         fMaxHeightCMD = new G4UIcmdWithADoubleAndUnit(path+"/maxHeight",this);
...
//         fSensitiveCMD = new G4UIcommand(path+"/sensitive",this);
...
//         //fMaximumHitSagittaCMD = new G4UIcmdWithADoubleAndUnit(CommandName("maxHitSagitta"),this);
//         fMaximumHitSagittaCMD = new G4UIcmdWithADoubleAndUnit(path+"/maxHitSagitta",this);
...
//         //fMaximumHitLengthCMD = new G4UIcmdWithADoubleAndUnit(CommandName("maxHitLength"),this);
//         fMaximumHitLengthCMD = new G4UIcmdWithADoubleAndUnit(path+"/maxHitLength",this);
...
// 	  msg << "ND280ConstructorMessenger is not implemented" << G4endl;
// 	  G4Exception("ND280ComponentConstructorMessenger::SetNewValue",
