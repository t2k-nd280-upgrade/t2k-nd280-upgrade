...
int main(int argc, char **argv)
{
    ...
    { // batch mode
        ...
        cout << " 2) input XML config file" << endl;
    ...
    ND280RootPersistencyManager *persistencyManager = ND280RootPersistencyManager::GetInstance();
    ...
    if (MyFirstEvent > (mytree->GetEntries() - 1))
    { // MyFirstEvent starts from 0
        G4cout << G4endl;
