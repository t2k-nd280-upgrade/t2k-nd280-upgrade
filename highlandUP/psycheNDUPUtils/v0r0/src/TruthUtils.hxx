...
namespace anaUtils{
  ...
  Float_t GetTrueLinearLengthInFGD(const AnaTrueParticleB& trueTrack, Float_t& distz);
  ...
  bool TrueParticleCrossesFGD(const AnaTrueParticleB*   track, SubDetId::SubDetEnum det = SubDetId::kTarget);
