#ifndef numuCC4piFwdCanSelection_h
#define numuCC4piFwdCanSelection_h
...
class numuCC4piFwdCanSelection: public SelectionBase{
public:
  numuCC4piFwdCanSelection(bool forceBreak=true);
  virtual ~numuCC4piFwdCanSelection(){
...
inline ToyBoxB* numuCC4piFwdCanSelection::MakeToyBox() {return new ToyBoxCC4pi();}
