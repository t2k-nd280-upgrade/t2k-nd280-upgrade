#ifndef numuCC4piCanSelection_h
#define numuCC4piCanSelection_h
...
class numuCC4piCanSelection: public SelectionBase{
public:
  numuCC4piCanSelection(bool forceBreak=true);
  virtual ~numuCC4piCanSelection(){
...
inline ToyBoxB* numuCC4piCanSelection::MakeToyBox() {return new ToyBoxCC4pi();}
