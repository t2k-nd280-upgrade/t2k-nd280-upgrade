...
public:
  ...
  enum enumStandardMicroTrees_numuCC4piAnalysis {
    ...
    selAll_ToF_time_muon,
    selAll_ToF_time_pion,
    selAll_ToF_time_electron,
    selAll_ToF_time_proton,
    selAll_ToF_time_sigma_muon,
    selAll_ToF_time_sigma_pion,
    selAll_ToF_time_sigma_electron,
    selAll_ToF_time_sigma_proton,
    selAll_PDG,
    selAll_nTracks,
    selAll_TPC_Edep,
    selAll_TPC_Length,
