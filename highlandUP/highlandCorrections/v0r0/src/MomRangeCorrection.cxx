...
//********************************************************************
double MomRangeCorrection::SmearMomentum( AnaTPCParticleB *cross, int pdg){
//********************************************************************
  double sigma=Sigma( cross,pdg)*cross->Momentum;
...
double MomRangeCorrection::Sigma( AnaTPCParticleB *cross,int pdg){
