...
class ndupAnalysis: public baseAnalysis {
 public:
  ndupAnalysis(AnalysisAlgorithm* ana=NULL);
  virtual ~ndupAnalysis(){}
...
public:
  ...
  enum enumStandardMicroTrees_ndupAnalysis{
   ...
   // true_tpc_sigma,
    ...
    enumStandardMicroTreesLast_ndupAnalysis
  };

  enum enumConf_ndupAnalysis{
    detmass_syst=baseAnalysis::enumConfLast_baseAnalysis+1,    
    dedx_syst,
    enumConfLast_ndupAnalysis
  };
