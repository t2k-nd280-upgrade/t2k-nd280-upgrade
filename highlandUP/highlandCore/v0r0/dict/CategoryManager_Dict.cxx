...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::CategoryManager*)
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::CategoryManager) == sizeof( ::ROOTShadow::Shadow::CategoryManager));
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CategoryManager", "./../src/CategoryManager.hxx", 54,
                  typeid(::CategoryManager), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::CategoryManager*)
   {
   ...
   static void CategoryManager_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const ::CategoryManager*)0x0)->GetClass();
   }
...
namespace ROOTDict {
   void CategoryManager_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      typedef ::ROOTShadow::Shadow::CategoryManager ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOTDict::GenerateInitInstanceLocal((const ::CategoryManager*)0x0)->GetClass();
...
} // end of namespace ROOTDict for class ::CategoryManager
...
namespace ROOTDict {
   ...
   // Function generating the singleton type initializer
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const map<string,TrackCategoryDefinition*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<string,TrackCategoryDefinition*>", -2, "/sps/t2k/mlamoure/repository/v12r1/ROOT/v5r34p34n00/Linux-x86_64/lib/root/cint/cint/lib/prec_stl/map", 63,
                  typeid(map<string,TrackCategoryDefinition*>), ::ROOT::DefineBehavior(ptr, ptr),
      ...
      instance.AdoptCollectionProxyInfo( ::ROOT::TCollectionProxyInfo::Generate( ::ROOT::TCollectionProxyInfo::MapInsert< map<string,TrackCategoryDefinition*> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   ...
   // Dictionary for non-ClassDef classes
   static void maplEstringcOTrackCategoryDefinitionmUgR_Dictionary() {
      ::ROOTDict::GenerateInitInstanceLocal((const map<string,TrackCategoryDefinition*>*)0x0)->GetClass();
   }
...
} // end of namespace ROOTDict for class map<string,TrackCategoryDefinition*>
...
/* CategoryManager */
static int G__CategoryManager_Dict_508_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 9:
...
static int G__CategoryManager_Dict_508_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((CategoryManager*) G__getstructoffset())->HasCategory(*(string*) libp->para[0].ref));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CategoryManager_Dict_508_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CategoryManager_Dict_508_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CategoryManager_Dict_508_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__CategoryManager_Dict_508_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
...
static int G__CategoryManager_Dict_508_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((CategoryManager*) G__getstructoffset())->GetCode(*(string*) libp->para[0].ref));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CategoryManager_Dict_508_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const CategoryManager*) G__getstructoffset())->IsReady());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__CategoryManager_Dict_508_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__CategoryManager_Dict_508_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__CategoryManager_Dict_508_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__CategoryManager_Dict_508_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncCategoryManager(void) {
   ...
   G__memfunc_setup("CategoryManager",1529,G__CategoryManager_Dict_508_0_1, 105, G__get_linked_tagnum(&G__CategoryManager_DictLN_CategoryManager), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ResetCurrentCategories",2284,G__CategoryManager_Dict_508_0_2, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddCategory",1095,G__CategoryManager_Dict_508_0_3, 121, -1, -1, 0, 9, 1, 1, 0, 
...
"g - - 0 'true' addSAND", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CopyCategory",1241,G__CategoryManager_Dict_508_0_4, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 11 - categ_name u 'string' - 11 - categ_name2", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HasCategory",1114,G__CategoryManager_Dict_508_0_5, 103, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - categ", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ReadCategories",1410,G__CategoryManager_Dict_508_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - file", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCategories",1318,G__CategoryManager_Dict_508_0_7, 117, G__get_linked_tagnum(&G__CategoryManager_DictLN_maplEstringcOTrackCategoryDefinitionmUcOlesslEstringgRcOallocatorlEpairlEconstsPstringcOTrackCategoryDefinitionmUgRsPgRsPgR), G__defined_typename("map<std::string,TrackCategoryDefinition*>"), 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DumpCategories",1436,G__CategoryManager_Dict_508_0_8, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DumpCategory",1236,G__CategoryManager_Dict_508_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - categ", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCategory",1118,G__CategoryManager_Dict_508_0_10, 117, G__get_linked_tagnum(&G__CategoryManager_DictLN_TrackCategoryDefinition), -1, 1, 1, 1, 1, 0, "u 'string' - 11 - categ", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCategoryTypes",1651,G__CategoryManager_Dict_508_0_11, 117, G__get_linked_tagnum(&G__CategoryManager_DictLN_vectorlETrackTypeDefinitioncOallocatorlETrackTypeDefinitiongRsPgR), G__defined_typename("vector<TrackTypeDefinition>"), 1, 1, 1, 1, 0, "u 'string' - 11 - categ", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCode",679,G__CategoryManager_Dict_508_0_12, 121, -1, -1, 0, 3, 1, 1, 0, 
"u 'string' - 11 - categ i - - 0 - code "
"i - - 0 '0' defaultcode", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCategoryType",1548,G__CategoryManager_Dict_508_0_13, 121, -1, -1, 0, 3, 1, 1, 0, 
"u 'string' - 11 - categ i - - 0 - type "
"g - - 0 - ok", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCode",667,G__CategoryManager_Dict_508_0_14, 105, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - categ", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CheckCategoryType",1726,G__CategoryManager_Dict_508_0_15, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'string' - 11 - categ i - - 0 - index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IsReady",689,G__CategoryManager_Dict_508_0_16, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetReady",801,G__CategoryManager_Dict_508_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - ok", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("CategoryManager", 1529, G__CategoryManager_Dict_508_0_18, (int) ('i'), G__get_linked_tagnum(&G__CategoryManager_DictLN_CategoryManager), -1, 0, 1, 1, 1, 0, "u 'CategoryManager' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~CategoryManager", 1655, G__CategoryManager_Dict_508_0_19, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__CategoryManager_Dict_508_0_20, (int) ('u'), G__get_linked_tagnum(&G__CategoryManager_DictLN_CategoryManager), -1, 1, 1, 1, 1, 0, "u 'CategoryManager' - 11 - -", (char*) NULL, (void*) NULL, 0);
